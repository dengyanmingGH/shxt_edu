...
- (id<SDWebImageOperation>)downloadImageWithURL:(NSURL *)url withHTTPHeader:(NSDictionary *)dict options:(SDWebImageDownloaderOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageDownloaderCompletedBlock)completedBlock
{
